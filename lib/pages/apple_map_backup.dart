...
class MapUiBodyState extends State<MapUiBody> {
    ...
    return Scaffold(
        body: Stack(
          ...
          children: [
            ...
            Positioned(
                bottom: 35,
                child: Container(height: 150, width: MediaQuery.of(context).size.width, color: Colors.orangeAccent, child: speedometer(),)
            ),
          ],
        )
    );
  ...
  Widget speedometer(){
    return Row(
      children: [
        Text('20', style: GoogleFonts.teko(fontSize: 250),)
      ],
    );
  }
